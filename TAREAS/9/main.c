...
int main (int argc, char *argu[]){
	...
	int numeroD;
	//se aprovecha la funcion strlen par saber cuantos caracteres tiene
	numeroD=strlen(argu[1]);
	//argumentos de caracteres es una nueva lista para guardar el numero
	char arguc[numeroD];
	//resultado empieza con el neutro aditivo
	int resultado=0;
	//digitos es una lista de eneros para guardar el numero
	int digitos[numeroD];
	//se suman los caracteres deacuerdo con el numero de digitos
